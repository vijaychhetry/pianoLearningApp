...
**Download (0.5.6 — latest, course menu):** [KidsPiano-debug-0.5.6.apk](./KidsPiano-debug-0.5.6.apk)

On GitHub, open that file and use **Download raw file**. On a phone, you can also use the raw URL for this branch:

https://github.com/vijaychhetry/pianoLearningApp/raw/cursor/merge-all-to-main-5032/releases/KidsPiano-debug-0.5.6.apk
...
6. **Kids Home** opens a left **Courses** drawer first. Tap a title to start that course; tap outside or pick a course and it hides. Sequential unlock is **off** (`REQUIRE_SEQUENTIAL_UNLOCK = false`) so every course is open for review. After all five keys, **Next** still advances; **Done** goes Home.
...
| Version | Notes |
| --- | --- |
| 0.5.6 | Left **Courses** drawer with titles. Sequential unlock flag is off so every course is open for review. |
