...
1. **Product (start here):** native Android app in [`android/`](android/) — Level 1 Find this key with an on-screen keyboard, plus grown-up Setup / Calibrate / Files / Audio Lab. Sideload [`releases/KidsPiano-debug-0.5.5.apk`](releases/KidsPiano-debug-0.5.5.apk).
